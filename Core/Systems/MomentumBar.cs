...
namespace ExampleMod.Common.UI.ExampleResourceUI
{
    ...
    internal class MomentumBar : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            area.Left.Set(-91f, 0.5f);
            area.Top.Set(30f, 0.5f);

            area.Width.Set(182f, 0f);
            area.Height.Set(60f, 0f);

            barFrame = new UIImage(ModContent.Request<Texture2D>("Anabasis/Core/Systems/MomentumBarFrame")); // Frame of our resource bar
            barFrame.Left.Set(38, 0f);
            barFrame.Top.Set(0, 0f);
            barFrame.Width.Set(102, 0f);
            ...
            gradientA = new Color(25, 150, 220); // A dark purple
            gradientB = new Color(65, 190, 255); // A light purple
        ...
        {
            if (Main.LocalPlayer.GetModPlayer<BlitzPlayer>().momentum <= 0)
                return;
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            var modPlayer = Main.LocalPlayer.GetModPlayer<BlitzPlayer>();
            // Calculate quotient
            float quotient = (float)modPlayer.momentum / modPlayer.maxMomentum; // Creating a quotient that represents the difference of your currentResource vs your maximumResource, resulting in a float of 0-1f.
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            text.SetText(ExampleResourceUISystem.ExampleResourceText.Format((int)modPlayer.momentum, (int)modPlayer.maxMomentum));
    ...
    internal class ExampleResourceUISystem : ModSystem
    {
        ...
        internal MomentumBar ExampleResourceBar;
