...
{
	public class FlamingCrimsrod : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.useTime = 32; // The length of the item's use time in ticks (60 ticks == 1 second.)
			...
			Item.shoot = ModContent.ProjectileType<FlamingCrimsrodProjectile>(); // The projectile that is fired from this weapon
		}
		...
		public override void AddRecipes() {
			CreateRecipe()
				...
				.AddIngredient(ItemID.Torch,150)
				.Register();
		}
	}
}