...
{
    public class AntlionDaggerProjectile : ModProjectile
    {

        public override string Texture => "Anabasis/Content/Items/Weapons/Blitz/AntlionDagger";

        public const int FadeInDuration = 7;
        public const int FadeOutDuration = 4;

        public const int TotalDuration = 28;
        ...
        public override void AI()
        {
            ...
            if (Timer == FadeInDuration && Projectile.owner == Main.myPlayer)
            {
                ...
                Main.projectile[ProjectileID].ai[1] = Projectile.whoAmI;
                Main.projectile[ProjectileID].rotation = stabDirection.ToRotation() + MathHelper.PiOver2 * Projectile.spriteDirection;
            }
        }
