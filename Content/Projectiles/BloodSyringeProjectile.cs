...
namespace Anabasis.Content.Projectiles
{
	...
	public class BloodSyringeProjectile : ModProjectile
	{
		...
		public override void OnKill(int timeLeft) { // Plays the basic sound most projectiles make when hitting blocks.
        ...
        {
            target.AddBuff(ModContent.BuffType<PokedDebuff>(),225);
        }
	}
}